export const LEVELS = {
    0: {
        ...
        "texts" : [
            ...
            { text: "The bird mask lets you jump again", x: 46, y: 8},
            { text: "while in the air", x: 46, y: 7},
            { text: "Jump!", x: 52, y: 2},
            { text: "Last mask is for spare", x: 66, y: 17 },
            { text: "The wrestler mask lets you destroy walls", x: 74, y: 15 },
            { text: "Use A/Q against the wall to destroy it", x: 84, y: 13 },
